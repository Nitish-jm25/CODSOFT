# import all functions from tkinter using *
from tkinter import *

# import messagebox class from tkinter
from tkinter import messagebox

# declare a global list to store tasks
tasks_list = []
...
if __name__ == "__main__" :
	...
	gui.title("my To-Do App")

	# set the configuration of GUI window 
	gui.geometry("1050x1100")

	# create a label : Enter Your Task
	enterTask = Label(gui, text = "Enter Task", bg = "pink")
	...
	TextArea = Text(gui, height = 5, width = 25, font = "Grotesk")

	# create a label : Delete Task Number
	taskNumber = Label(gui, text = "Delete Task Number", bg = "pink")
						
	taskNumberField = Text(gui, height = 1, width = 2, font = "Grotesk")
